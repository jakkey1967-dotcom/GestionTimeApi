-- ================================================================
-- FRESHDESK TICKET HEADER SYNC TABLES
-- Schema: pss_dvnx
-- Descripción: Tablas para sincronización de cabeceras de tickets
-- ================================================================

-- ================================================================
-- Tabla: freshdesk_ticket_header
-- Almacena cabeceras de tickets de Freshdesk (sin conversaciones)
-- ================================================================
...
-- ================================================================
-- Tabla: freshdesk_sync_state
-- Guarda el estado de las sincronizaciones
-- ================================================================
...
-- Seed opcional del scope para que exista desde el inicio
...
-- Verificación
-- ================================================================
select 'freshdesk_ticket_header' as tabla, count(*) as registros 
from pss_dvnx.freshdesk_ticket_header
union all
select 'freshdesk_sync_state' as tabla, count(*) as registros 
