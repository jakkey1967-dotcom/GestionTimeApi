...
SELECT 
    ...
    u.last_login_at as ultima_sesion,
    CASE 
        WHEN u.last_login_at IS NULL THEN 'Nunca ha iniciado sesi?n'
        ELSE CONCAT(
            EXTRACT(DAY FROM (NOW() - u.last_login_at))::INT, ' d?as, ',
...
-- ========================================
-- 4?? ACTIVIDAD DIARIA (?LTIMOS 30 D?AS)
-- ========================================
SELECT 
    '=== ACTIVIDAD DIARIA (?LTIMOS 30 D?AS) ===' as seccion;
...
-- ========================================
SELECT 
    '=== PARTES POR USUARIO Y FECHA (?LTIMOS 15 D?AS) ===' as seccion;
...
-- ========================================
-- 7?? TOP 5 USUARIOS M?S ACTIVOS
-- ========================================
SELECT 
    '=== TOP 5 USUARIOS M?S ACTIVOS ===' as seccion;
...
-- ========================================
-- 8?? ACTIVIDAD POR SEMANA (?LTIMAS 4 SEMANAS)
-- ========================================
SELECT 
    '=== ACTIVIDAD SEMANAL (?LTIMAS 4 SEMANAS) ===' as seccion;
...
-- ========================================
-- 9?? CLIENTES M?S TRABAJADOS (TOP 10)
-- ========================================
SELECT 
    '=== CLIENTES M?S TRABAJADOS ===' as seccion;
...
-- ========================================
SELECT 
    '=== ESTAD?STICAS POR M?DULO ===' as seccion;
