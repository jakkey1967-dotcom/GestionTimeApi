...
namespace GestionTime.Infrastructure.Migrations
{
    ...
    [Migration("20260301110134_AddEmailOutboxAndDesktopClientHealth")]
    partial class AddEmailOutboxAndDesktopClientHealth
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GestionTime.Domain.Reports.VPartesStatsFull", b =>
                {
                    ...
                    b.Property<string>("AgenteEmail")
                        .HasColumnType("text")
                        .HasColumnName("agente_email");

                    b.Property<string>("AgenteNombre")
                        .HasColumnType("text")
                        .HasColumnName("agente_nombre");
                    ...
                    b.Property<decimal?>("DuracionHorasTs")
                        .HasColumnType("numeric")
                        .HasColumnName("duracion_horas_ts");

                    b.Property<int?>("DuracionMin")
                        .HasColumnType("integer")
                        .HasColumnName("duracion_min");

                    b.Property<decimal?>("DuracionMinTs")
                        .HasColumnType("numeric")
                        .HasColumnName("duracion_min_ts");

                    b.Property<string>("Estado")
                        .HasColumnType("text")
                        .HasColumnName("estado");

                    b.Property<DateTime?>("FechaDia")
                        .HasColumnType("timestamp with time zone")
                    ...
                    b.Property<int?>("SemanaIso")
                        .HasColumnType("integer")
                        .HasColumnName("semana_iso");
                    ...
                    b.ToView("v_partes_stats_full", "pss_dvnx");
                });

            modelBuilder.Entity("GestionTime.Domain.Versioning.AppSetting", b =>
                {
                    ...
                    b.ToTable("app_settings", "pss_dvnx");
                });

            modelBuilder.Entity("GestionTime.Domain.Versioning.ClientVersion", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<string>("AppVersionRaw")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                        .HasColumnName("app_version_raw");
                    ...
                    b.Property<int>("VerPatch")
                        .HasColumnType("integer")
                        .HasColumnName("ver_patch");

                    b.Property<string>("VerPrerelease")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                        .HasColumnName("ver_prerelease");

                    b.HasKey("Id");

                    b.HasIndex("UserId", "LoggedAt")
                        .HasDatabaseName("idx_client_versions_user_logged");

                    b.HasIndex("VerMajor", "VerMinor", "VerPatch")
                        .HasDatabaseName("idx_client_versions_ver");

                    b.ToTable("client_versions", "pss_dvnx");
                });

            modelBuilder.Entity("GestionTime.Domain.Versioning.EmailOutbox", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<string>("TargetVersionRaw")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                        .HasColumnName("target_version_raw");
                    ...
                    b.HasIndex("DedupeKey")
                        .IsUnique()
                        .HasDatabaseName("uq_email_outbox_dedupe");

                    b.HasIndex("Status")
                        .HasDatabaseName("idx_email_outbox_status");

                    b.HasIndex("UserId", "CreatedAt")
                        .HasDatabaseName("idx_email_outbox_user_created");

                    b.ToTable("email_outbox", "pss_dvnx");
                });

            modelBuilder.Entity("GestionTime.Domain.Versioning.VDesktopClientLastVersion", b =>
                {
                    b.Property<string>("AppVersionRaw")
                        .IsRequired()
                        .HasColumnType("text")
                    ...
                    b.ToView("v_desktop_client_last_version", "pss_dvnx");
                });
            ...
            modelBuilder.Entity("GestionTime.Domain.Work.ClienteNota", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("ClienteId")
                        .IsUnique()
                        .HasDatabaseName("idx_cliente_notas_cliente_id")
                        .HasFilter("owner_user_id IS NULL");

                    b.HasIndex("ClienteId", "OwnerUserId")
                        .IsUnique()
                        .HasDatabaseName("uq_cliente_notas_personal")
                        .HasFilter("owner_user_id IS NOT NULL");

                    b.ToTable("cliente_notas", "pss_dvnx");
                });
            ...
            modelBuilder.Entity("GestionTime.Domain.Work.ClienteNota", b =>
                {
                    b.HasOne("GestionTime.Domain.Work.Cliente", "Cliente")
                        .WithMany()
